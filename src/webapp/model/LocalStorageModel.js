sap.ui.define([
  ...
  return JSONModel.extend('com.mlauffer.gotmoneyappui5.model.LocalStorageModel', {

    _STORAGE_KEY: 'GMA_LOCALSTORAGE_MODEL',
     ...
     * By default the string "GMA_LOCALSTORAGE_MODEL" is used but it is recommended to set a custom key
     ...
     * @return {com.mlauffer.gotmoneyappui5.model.LocalStorageModel} the local storage model instance
     */
